...
// Models that support context shifting (e.g. by applying a RoPE
// offset) should implement this interface
type ModelWithShift interface {
	Shift(ctx ml.Context, layer int, key, shift ml.Tensor) (ml.Tensor, error)
}
